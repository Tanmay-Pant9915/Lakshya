  ...
  const questions = [
    {
      ...
      options: ["Lion", "Deer", "Grass", "Snake"],
      correct: "Grass"
    },
    {
      question: "What is the process by which plants make their own food using sunlight?",
      options: ["Respiration", "Transpiration", "Germination", "Photosynthesis"],
    ...
    },
    {
      ...
      options: ["Barometer", "Thermometer", "Anemometer", "Ruler"],
      correct: "Thermometer"
    },
    {
    ...
    {
      question: "What is the name of the protective layer of gas that surrounds the Earth?",
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex justify-between items-center mb-6">
              <h1 className="text-2xl font-bold text-emerald-600">🔬 Science Quiz</h1>
              <button
              ...
              <div>
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="flex-1 bg-emerald-500 hover:bg-emerald-600 disabled:bg-gray-300 text-white py-3 rounded-lg font-semibold transition"
                  >
                  ...
                  <button
                    onClick={() => {
                      if (selectedAnswer) {
                        ...
                        alert(isCorrect ? 'Correct!' : `Incorrect. The correct answer is: ${questions[currentQuestion].correct}`);
                      }
                    }}
                    disabled={!selectedAnswer}
                    className="bg-blue-500 hover:bg-blue-600 disabled:bg-gray-300 text-white px-4 py-3 rounded-lg font-semibold transition"
                  >
                    Check Answer
                  </button>
                </div>
